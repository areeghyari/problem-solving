...
const objLat = (obj) => {
    let obj = ` my name is ${this.firstName}  ${this.lastName} I am ${this.age} YO, and I love ${this.hoppy}`;
...
const cvFormatter = (arr) => {
    let arr  = `{{ ${this.fulltName} ,  ${this.tech} } , { ${this.firstName} , ${this.tech} },{ ${this.fulltName} , ${this.tech}}}`;
